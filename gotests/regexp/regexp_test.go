...
func TestRegexps(t *testing.T) {
	tests := []struct {
		...
		testData: []RegexpTest{
			...
			RegexpTest{`2001:FFF:DB8:ABCD:FFFF:CAFE:00D1::FFF/128`, false},
			RegexpTest{`2001:FFF:DB8:ABCD:FFFF::CAFE:00D1/128`, true},
			RegexpTest{`2001:FFF:DB8:ABCD::FFFF:CAFE:00D1/128`, true},
			RegexpTest{`2001:FFF:DB8::ABCD:FFFF:CAFE:00D1/128`, true},
			RegexpTest{`2001:FFF::DB8:ABCD:FFFF:CAFE:00D1/128`, true},
			RegexpTest{`2001::FFF:DB8:ABCD:FFFF:CAFE:00D1/128`, true},
			...
			// Examples from RFC 4291
			RegexpTest{"2001:0DB8:0000:CD30:0000:0000:0000:0000/60", true},
			RegexpTest{"2001:0DB8::CD30:0:0:0:0/60", true},
			RegexpTest{"2001:0DB8:0:CD30::/60", true},
			RegexpTest{"2001:0DB8:0:CD3/60", false},
		},
	}, {
		name:    "ip-prefix",
		modules: []string{"testdata/test.yang"},
		...
		testData: []RegexpTest{
			...
			RegexpTest{`2001:FFF:DB8:ABCD:FFFF::CAFE:00D1`, true},
			RegexpTest{`2001:FFF:DB8:ABCD::FFFF:CAFE:00D1`, true},
			RegexpTest{`2001:FFF:DB8::ABCD:FFFF:CAFE:00D1`, true},
			RegexpTest{`2001:FFF::DB8:ABCD:FFFF:CAFE:00D1`, true},
			RegexpTest{`2001::FFF:DB8:ABCD:FFFF:CAFE:00D1`, true},
			RegexpTest{`::2001:FFF:DB8:ABCD:FFFF:CAFE:00D1`, true},
			// Examples from RFC 4291
			RegexpTest{"2001:DB8::8:800:200C:417A", true},
			RegexpTest{"FF01::101", true},
			RegexpTest{"::1", true},
		},
	}, {
